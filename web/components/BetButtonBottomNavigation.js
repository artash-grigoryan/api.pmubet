...
const BetButton = ({race, className}) => {
    ...
    return (
        <React.Fragment>
            <BottomNavigationAction onClick={()=>setDialogStatus('opened')} showLabel={true} className="bottom-navigation-bet-button" icon={<NearMeOutlinedIcon />} label={<Trans i18nKey="Play online">Play online</Trans>}  />
