...
Route::middleware(['cors'])->group(function () {
    ...
    Route::get('{locale}/race/get/next',     "RaceController@getNextQ5");
    Route::get('{locale}/race/get/nextQ5',   "RaceController@getNextQ5Minimalist");
    ...
    Route::get('{locale}/race/get/{date}/next',                          "RaceController@getNextQ5ByDate");
